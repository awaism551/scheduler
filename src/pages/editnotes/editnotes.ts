...
export class EditnotesPage {
  ...
  ionViewDidLoad() {
   ...
   get_user_notes(noteid){
     ...
     loading.present();
    let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/getnotesbyid";
    let postdata = {
  ...
  add_notes(){
    if(this.noteForm.valid){
     ...
     loading.present();
      let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/stickynotesupdate";
