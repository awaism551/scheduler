...
/**
 * Generated class for the EditnewtaskPage page.
 *
...
export class EditnewtaskPage {
  ...
  ionViewDidLoad() {
   ...
   get_user_tasks(taskid){
    ...
    let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/get_user_taskbyid";
    let postdata = {
      ...
      .subscribe(
        (data) => {
		  ...
		  console.log(taskList.all_tasks[0].name)
		   ...
		   //this.id=taskList.all_tasks[0].id;
		  //console.log(taskList.all_tasks[0].id);
          /* console.log(this.allTask)
		  this.duration=taskList.all_tasks[0].duration; 
		  console.log(duration); */
		  loading.dismiss();
		  
		  //this.subtaskArray.push({"value":"1st task"},{"value":"2nd tsk"});
		  //console.log(this.subtaskArray);
		  //this.subtaskArray.push({ 'value': 'ta' });
		  //this.subtaskArray.push({ 'value': 'ta' });
		 // this.subtaskArray.push({ 'value': 'ta' });
		 //console.log(this.subtaskArray); 
  ...
  addTask(){
    if (this.newTaskform.valid){
      ...
      if (this.subtaskArray != null){
        ...
        let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/update_task";
        ...
        let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/create_task";
        this.http.post(_url, taskdata, { headers: this.headers })
          .subscribe(
            (data) => {
              let result = JSON.parse(data["_body"]);
