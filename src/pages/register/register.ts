...
export class RegisterPage {
  ...
  sentotp()
  {
	  ...
	  let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/regotp";
  ...
  signup() {
    ...
    if (this.signupform.valid) {
      ...
      let loading = this.loadingCtrl.create({
            ...
            loading.present(); 
      //let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/register";
	  let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/regotpverify";
      this.http.post(_url, regdata, { headers: this.headers })
        .subscribe(
          (data) => {
            let result = JSON.parse(data["_body"]);
  ...
  /* signupold() {
    ...
    if (this.signupform.valid) {
      ...
      let loading = this.loadingCtrl.create({
            ...
            loading.present(); 
      //let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/register";
	  let _url: string = "http://ec2-52-59-226-149.eu-central-1.compute.amazonaws.com/api/v1/user/reg";
      this.http.post(_url, regdata, { headers: this.headers })
        .subscribe(
          (data) => {
            let result = JSON.parse(data["_body"]);
